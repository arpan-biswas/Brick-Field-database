...
echo "<table style='border: solid 1px black;'>";
  echo "<tr><th>Id</th><th>First Name</th><th>Last Name</th><th>UserName</th><th>Department<th>Phone</tr>";
...
try {
     ...
     $stmt = $conn->prepare("SELECT id, first_name,last_name,username,user_level,phone FROM employee"); 
     $stmt->execute();
