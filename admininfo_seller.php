...
<?php 
    ...
    $sql = "DELETE FROM seller_seller where id = $id";
...
echo "<table style='border: solid 1px black;'>";
  echo "<tr><th>Id</th><th>First Name</th><th>Last Name</th><th>Username</th><th>Email</th></tr>";
...
try {
     ...
     $stmt = $conn->prepare("SELECT id, first_name, last_name,username,email FROM seller_signup"); 
     $stmt->execute();
