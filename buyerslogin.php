	...
	<div class="main" style="background-color: #ff6600">
		<div class="header" style="background-color: #00ff99;" >
			...
			<form action="insert_buyer.php" method="post" id="insertForm">
				<ul class="left-form">
					<h2 style="font-size: 30px; color: #FF8C00;"></br>New Account:</h2>
					<li>
					...
					<li>
						...
						<p style="margin-right: 80px"><input type="submit" name="submit" id="Sign_Up" value="Sign Up"></p>
				</ul>
			</form>
			</div>
			<div>
			<form action="process_buyer.php" method="POST">
				<ul class="right-form">
					<br><h2 style="font-size: 30px; color: #FF8C00;"><br>Login:</h2><br>
					<div>
						<li><input type="text"  placeholder="Username" name="username" /></li>
						<li> <input type="password"  placeholder="Password" name="password" /></li>
					    <li style="margin-left: 350px"><input type="submit" name="submit" id="btn" value="Log In"> </li>
